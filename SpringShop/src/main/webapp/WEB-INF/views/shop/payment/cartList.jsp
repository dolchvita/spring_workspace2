...
<%
	// 장바구니를 세션으로 구현했으므로, 세션에 들어있는 장바구니 관련 객체를 끄집어 표로 출력하자!
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart__close"><span class="icon_close" onClick="delCart(<%=product.getProduct_idx()%>)"></span></td>
                                </tr>
...
<script type="text/javascript">
	function delCart(product_idx){
		
		// 장바구니 삭제 요청
		if(confirm("선택한 상품을 장바구니에서 삭제하시겠어요?")){
			location.href="/payment/delcart.jsp?product_idx="+product_idx;
		}
	}	
